...
public class PatientDbHelper extends SQLiteOpenHelper {
    ...
    private static final int DB_VERSION = 3; // 升级数据库版本
    ...
    public static final String COL_PHYSICIAN_NAME = "physician_name";  // 医生姓名
    public static final String COL_PHYSICIAN_CODE = "physician_code";  // 医生工号
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createInfoTable = "CREATE TABLE " + TABLE_INFO + " ("
                ...
                + COL_AGE + " INTEGER, "
                + COL_GENDER + " TEXT, "
                + COL_PHYSICIAN_NAME + " TEXT, "   // 医生姓名
                + COL_PHYSICIAN_CODE + " TEXT, "   // 医生工号
                + COL_DIAGNOSIS + " TEXT, "
                + COL_STAGE + " TEXT, "
